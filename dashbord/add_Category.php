...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Category(Category_img, Category_name, Category_description) VALUES ('$imgContent', '$name', '$description')";
...
<form method="post" enctype="multipart/form-data">
    ...
    <input type="file" name="Category_img" accept="image/*" required><br>
...
<a class="d-sm-inline-block btn btn-sm btn-primary shadow-sm" target="_blank" href="Tables_Category.php">Back to Category</a> -->
...
<div class="container mt-1 mb-5">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="Category_img">Image:</label>
                <input type="file" class="form-control-file" name="Category_img" accept="image/*" required>
            </div>
            <div class="form-group">
                <label for="Category_name">Name:</label>
