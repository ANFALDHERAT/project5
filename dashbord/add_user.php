...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO user(user_img, user_name, user_email,user_phone,user_role,user_location) VALUES ('$imgContent', '$name', '$email', '$phone', '$role', '$location')";
...
$categoryQuery = "SELECT user_id, user_name FROM Category";
...
<form method="post" enctype="multipart/form-data">
    ...
    <input type="file" name="user_img" accept="image/*" required><br>

    <label for="user_name">Name:</label>
    <input type="text" name="user_name" required><br>

    <label for="user_password">Password:</label>
    <input type="number" name="user_password" required><br>
    ...
    <input type="text" name="user_location" required><br>
...
<a class="d-sm-inline-block btn btn-sm btn-primary shadow-sm" target="_blank" href="Tables_users.php">Back to Users</a>
