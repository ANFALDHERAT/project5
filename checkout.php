...
if (!empty($_SESSION['products'])) {
    foreach ($_SESSION['products'] as $key => $value) {
        ...
        $insertQuery = "INSERT INTO order_products (product_name, price, total, user_name, user_email, user_address, user_city, zip_code, phone) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

        $stmt = $conn->prepare($insertQuery);

        // Bind parameters
        $stmt->bind_param("sddssssii", $productName, $productPrice, $productTotal, $user_name, $user_email, $user_address, $user_city, $zip_code, $phone);
try {
    $stmt->execute();
    ...
    echo "Error: " . $e->getMessage();
        ...
        // if ($stmt->execute()) {
        //     echo "Order for $productName placed successfully!<br>";
        // } else {
        //     echo "Error for $productName: " . $stmt->error . "<br>";
        // }
