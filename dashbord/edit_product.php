...
<div class="container mt-1 mb-5">
        ...
        <form method="post" enctype="multipart/form-data">
            <?php echo '<div class="mb-3">' . '<img high="300px" width="300px" class="img-thumbnail" src="data:image/jpeg;base64,' . base64_encode($row["products_img"]) . '" alt="Image">' . '</div>'; ?><br>
            <div class="form-group">
                <label for="img">Image:</label>
                <input type="file" class="form-control-file" name="img" accept="image/*" required>
            </div>

            <input type="hidden" name="product_id" value="<?php echo $row['product_id']; ?>" required>
            <div class="form-group">
                <label for="name">Name:</label>
                <input type="text" class="form-control" name="name" value="<?php echo $row['products_name']; ?>">
            </div>
            <div class="form-group">
                <label for="description">Description:</label>
                <input type="text" class="form-control" name="description" value="<?php echo $row['products_description']; ?>" required>
            </div>
            <div class="form-group">
                <label for="quantity">Quantity:</label>
                <input type="number" class="form-control" name="quantity" value="<?php echo $row['products_quantity']; ?>" required>
            </div>
            <div class="form-group">
                <label for="price">Price:</label>
                <input type="number" class="form-control" name="price" value="<?php echo $row['products_price']; ?>" required>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" name="category_id">
                    ...
                    while ($categoryRow = $categoryResult->fetch_assoc()) {
                        ...
                        echo ">" . $categoryRow["Category_name"] . "</option>";
                    }
                    ?>
                </select>
            </div>
            <button type="submit" class="btn btn-primary" name="confirm">Update Product</button>
