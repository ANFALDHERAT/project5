				...
				<div class="row">
					...
					<div class="store-filter clearfix">
							...
							<form method="get">
								...
								<input type="submit" value="Apply Filter" style="background-color:#D10024;padding:5px;border:1px solid #D10024;color:white ">
							</form>
					...
					<div class="col-md-4 col-xs-6">
								...
								<input type="number" name="products_quantity" value="1" class="form-control">
